...
""" Load sprite sheet """
spritesheet = pygame.image.load("assets/player/PNG/Slime1/Without_shadow/Slime1_Idle_without_shadow.png")
...
updatePlayerPosVariable() # update the play pos once on run to enable first movement
...
sprite1 = get_image(spritesheet, 17, 18) # load the sprite as a variable specifing the spritesheet and the width and height of the sprite
sprite1Rect = sprite1.get_rect() # creates the rect of sprite1
